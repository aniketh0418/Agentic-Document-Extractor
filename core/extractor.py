...
# GEMINI_MODEL = os.getenv("OPENAI_MODEL", "gemini-2.5-flash")
...
# # --- Call Gemini ---
# def _call_gemini(single_user_message: str, model: str = GEMINI_MODEL) -> str:
#     generation_config = {
#         "temperature": 0.3,
#         "top_p": 0.95,
#         "top_k": 40,
...
#     response = model_instance.generate_content(single_user_message)
...
#     raw = _call_gemini(user_msg, model=GEMINI_MODEL)
